          ...
          <div class="p-4 sm:p-7">
            <div class="text-center">
              ...
              <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <a class="font-medium text-blue-600 decoration-2 hover:underline dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/login">
                  Sign in here
                </a>
              </p>
            </div>
            ...
            <form>
              <div class="grid gap-y-4">
                ...
                <div>
                  ...
                  <div class="relative">
                    <input type="text" id="name" name="name" class="block w-full px-4 py-3 text-sm border border-gray-200 rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" required aria-describedby="email-error">
