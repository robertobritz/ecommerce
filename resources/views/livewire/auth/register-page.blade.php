            ...
            <div class="bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700">
                <div class="p-4 sm:p-7">
                    <div class="text-center">
                        <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">Cadastro</h1>
                    ...
                    <form wire:submit.prevent='save'>
                        <div class="grid gap-y-4">
                            ...
                            <div>
                                <label for="name" class="block mb-2 text-sm dark:text-white">Nome</label>
                                <div class="relative">
