          ...
          <div class="p-4 sm:p-7">
            <div class="text-center">
              ...
              <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <a class="font-medium text-blue-600 decoration-2 hover:underline dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/register">
                  Sign up here
                </a>
              </p>
            </div>
              ...
              <div class="grid gap-y-4">
                ...
                <div>
                  <div class="flex items-center justify-between">
                    ...
                    <a class="text-sm font-medium text-blue-600 decoration-2 hover:underline dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/forgot">Forgot password?</a>
                  </div>
                  <div class="relative">
