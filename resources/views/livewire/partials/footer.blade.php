    ...
    <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
        ...
        <div class="grid grid-cols-2 gap-6 md:grid-cols-4 lg:grid-cols-5">
            ...
            <div class="col-span-1">
                <h4 class="font-semibold text-gray-100">Produtos</h4>

                <div class="grid mt-3 space-y-3">
                    <p><a class="inline-flex text-gray-400 gap-x-2 hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/categories">Categorias</a></p>
                    <p><a class="inline-flex text-gray-400 gap-x-2 hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/products">Todos os Produtos</a></p>
                    <p><a class="inline-flex text-gray-400 gap-x-2 hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/products">Produtos em Destaque</a></p>
                </div>
            </div>
            <!-- End Col -->
            ...
            <div class="col-span-2">
                <h4 class="font-semibold text-gray-100">Fique por dentro</h4>
        ...
        <div class="grid mt-5 sm:mt-12 gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
            <div class="flex items-center justify-between">
                <p class="text-sm text-gray-400">© 2024 Ecommerce. Todos os direitos reservados.</p>
            </div>
            <!-- End Col -->

            <!-- Social Brands -->
            <div>
                <a class="inline-flex items-center justify-center w-10 h-10 text-sm font-semibold text-white border border-transparent rounded-lg gap-x-2 hover:bg-white/10 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:ring-1 focus:ring-gray-600"
                    href="#">
