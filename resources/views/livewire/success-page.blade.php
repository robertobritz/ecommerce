    ...
    <div class="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto bg-white border rounded-md dark:border-gray-900 dark:bg-gray-900 md:py-10 md:px-10">
      <div>
        ...
        <div class="flex items-center justify-start gap-4 px-4 mt-6 ">
          ...
          <a href="/orders" class="w-full px-4 py-2 text-center bg-blue-500 rounded-md text-gray-50 md:w-auto dark:text-gray-300 hover:bg-blue-600 dark:hover:bg-gray-700 dark:bg-gray-800">
            View My Orders
          </a>
        </div>
      </div>
