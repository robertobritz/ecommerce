            ...
            <div class="flex flex-wrap -mx-4">
                    ...
                    <div class="sticky top-0 z-50 overflow-hidden ">
                        ...
                        <div class="px-6 pb-6 mt-6 border-t border-gray-300 dark:border-gray-400 ">
                            <div class="flex flex-wrap items-center mt-6">
                                ...
                                <h2 class="text-lg font-bold text-gray-700 dark:text-gray-400">Frete Grátis</h2>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="w-full px-4 md:w-1/2 ">
                    <div class="lg:pl-20">
                        ...
                        <div class="w-32 mb-8 ">
                            <label for=""
                                class="w-full pb-1 text-xl font-semibold text-gray-700 border-b border-blue-300 dark:border-gray-600 dark:text-gray-400">Quantidade</label>
                        ...
                        <div class="flex flex-wrap items-center gap-4">
                            <button wire:click='addToCart({{ $product->id }})'
                                ...
                                <span wire:loading.remove wire:target='addToCart({{ $product->id }})'>Adicionar ao
                                    carrinho</span> <span wire:loading
                                    wire:target='addToCart({{ $product->id }})'>Adicionando...</span>
                            </button>
                        </div>
                    </div>
                </div>
