                    ...
                    <div class="p-4 bg-white shadow rounded-xl sm:p-7 dark:bg-slate-900">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mt-4">
                                ...
                                <input wire:model='phone' class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white dark:border-none @error('phone') border-red-500 @enderror" id="phone" type="text">
                                </input>
                                @error('phone')
                                <div class="text-sm text-red-500"> {{ $message }} </div>
                                @enderror
                            ...
                            <div class="mt-4">
                                ...
                                <input wire:model='street_address' class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white dark:border-none @error('street_address') border-red-500 @enderror" id="address" type="text">
                                </input>
                            ...
                            <div class="mt-4">
                                ...
                                <input wire:model='city' class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white dark:border-none @error('city') border-red-500 @enderror" id="city" type="text">
                                </input>
                                @error('city')
                                <div class="text-sm text-red-500"> {{ $message }} </div>
                                @enderror
                            ...
                            <div class="grid grid-cols-2 gap-4 mt-4">
                                <div>
                                    ...
                                    <input wire:model='state' class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white dark:border-none @error('state') border-red-500 @enderror" id="state" type="text">
                                    </input>
                                    @error('state')
                                    <div class="text-sm text-red-500"> {{ $message }} </div>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input wire:model='zip_code' class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white dark:border-none @error('zip_code') border-red-500 @enderror" id="zip" type="text">
                                    </input>
                                    @error('zip_code')
                                    <div class="text-sm text-red-500"> {{ $message }} </div>
                                    @enderror
                ...
                <div class="col-span-12 md:col-span-12 lg:col-span-4">
                    <div class="p-4 bg-white shadow rounded-xl sm:p-7 dark:bg-slate-900">
                        ...
                        <div class="flex justify-between mb-2 font-bold">
                            ...
                            <span>
                                {{ Number::currency($grand_total, 'BRL')  }}
                            </span>
                        </div>
                        <div class="flex justify-between mb-2 font-bold">
                            <span>
                                ...
                                <li class="py-3 sm:py-4" wire:key='{{ $ci['product_id'] }}'>
                                    <div class="flex items-center">
                                        ...
                                        <div class="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                                            {{ Number::currency($ci['total_amount'], 'BRL') }}
                                        </div>
                                    </div>
                                </li>
                            @endforeach
