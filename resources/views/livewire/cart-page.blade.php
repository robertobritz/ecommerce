            ...
            <section class="bg-white rounded-xl shadow-sm">
                <div class="p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-gray-600">Revise seus itens e prossiga para o checkout</p>
                    </div>
                                                ...
                                                <tr wire:key='{{ $item['product_id'] }}'
                                                    ...
                                                    <td class="px-6 py-4">
                                                        <div class="flex items-center">
                                                            <img class="object-cover w-20 h-20 mr-4 rounded-lg"
                                                ...
                                                <tr>
                                                    <td colspan="5" class="px-6 py-12">
                                                        <div class="text-center">
                                                            ...
                                                            <h3 class="mt-4 text-lg font-medium text-gray-900">Seu
                                                                carrinho
                                                                está vazio</h3>
                        ...
                        <div class="lg:w-1/4">
                            <div class="overflow-hidden bg-gray-50 rounded-xl shadow-sm">
                                <div class="p-6">
                                    ...
                                    @if ($cart_items)
                                        <a href="/checkout"
                                            class="block w-full px-4 py-3 mt-6 text-sm font-semibold text-center text-white transition-colors bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                                            Finalizar Compra
                                        </a>
                                    @endif
                                </div>
